...
class WanModelStateDictConverter:
    ...
    def from_civitai(self, state_dict):
        ...
        elif hash_state_dict_keys(state_dict) == "e1152dffccb2a7a3872ef0d01f3fc8d5":
            # Wan-AI/Wan2.2-Fun-5B-InP (Inpaint model with 100 channels)
            config = {
                "has_image_input": False,
                "patch_size": [1, 2, 2],
                "in_dim": 100,
        ...
        elif hash_state_dict_keys(state_dict) == "f5bb23289a8ff2e6e6c26d4dbf2c75fe":
            # Wan2.1-Fun-14B-InP (PAI)
            # patch_embedding.weight: [5120, 36, 1, 2, 2], ffn: 13824, layers: 40, has k_img
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
                "in_dim": 36,
