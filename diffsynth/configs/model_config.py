...
model_loader_configs = [
    # The format is (file_path, state_dict_keys_hash_with_shape, model_names, model_classes, model_resource)
    ...
    (None, "e1152dffccb2a7a3872ef0d01f3fc8d5", ["wan_video_dit"], [WanModel], "civitai"),
    ...
    (None, "06be60f3a4526586d8431cd038a71486", ["wans2v_audio_encoder"], [WanModel], "civitai"),
