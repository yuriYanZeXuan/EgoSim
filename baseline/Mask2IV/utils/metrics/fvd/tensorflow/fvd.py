"""
Copy-pasted from https://github.com/google-research/google-research/blob/master/frechet_video_distance/frechet_video_distance.py
Copy-pasted from https://github.com/universome/fvd-comparison/blob/master/their_fvd.py
"""
...
def preprocess(videos, target_resolution):
  ...
  scaled_videos = tf.clip_by_value(scaled_videos, -1, 1) 
...
def create_id3_embedding(videos):
  ...
  module_spec = "/home/u1120230288/hjy/code/common_metrics_on_video_quality/fvd/tensorflow/i3d-kinetics-tensorflow1-400-v1"
